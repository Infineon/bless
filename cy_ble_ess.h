...
typedef struct
{
     ...
     * ES Characteristic
     */
    const cy_stc_ble_esss_char_t *charInfoPtr;
...
extern const cy_stc_ble_esss_config_t *cy_ble_esssConfigPtr;
extern const cy_stc_ble_essc_config_t *cy_ble_esscConfigPtr;
